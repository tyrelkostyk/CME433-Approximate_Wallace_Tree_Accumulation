...
print("Distance Percentage:", ((error_distance1/errors1)/65025) * 100, "%")
print("-----------------------------------")

print("Results: First Layer Approximate")
print("Number of errors:", errors2)
print("Error Percentage:", (errors2/lines) * 100, "%")
print("Mean error distance:", error_distance2/errors2)
print("Distance Percentage:", ((error_distance2/errors2)/65025) * 100, "%")
print("-----------------------------------")

print("Results: Fully Approximate")
print("Number of errors:", errors3)
print("Error Percentage:", (errors3/lines) * 100, "%")
print("Mean error distance:", error_distance3/errors3)
print("Distance Percentage:", ((error_distance3/errors3)/65025) * 100, "%")
print("-----------------------------------")
